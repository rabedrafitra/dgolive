    ...
    <Wrapper>
      <div className="py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-5xl font-extrabold text-black shadow-sm">Contactez-Nous</h1>
        ...
        <div className="max-w-3xl mx-auto mb-16">
          <h2 className="text-2xl font-semibold text-center mb-6">Suivez-Nous</h2>
        ...
        <div className="bg-gray-100 py-12 rounded-lg">
          <h2 className="text-3xl font-semibold text-center mb-8">Pourquoi choisir notre plateforme ?</h2>
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-4">
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
                fill="none"
                stroke={hoveredIcon === 'camera' ? '#2563EB' : '#4B5563'}
                strokeWidth="2"
              ...
              <h3 className="text-lg font-semibold mt-4">Live Shopping</h3>
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
                fill="none"
                stroke={hoveredIcon === 'cart' ? '#2563EB' : '#4B5563'}
                strokeWidth="2"
              ...
              <h3 className="text-lg font-semibold mt-4">Commandes Simplifiées</h3>
              <p className="text-gray-600 mt-2">
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
                fill="none"
                stroke={hoveredIcon === 'chart' ? '#2563EB' : '#4B5563'}
                strokeWidth="2"
              ...
              <h3 className="text-lg font-semibold mt-4">Analyse des Données</h3>
              <p className="text-gray-600 mt-2">
